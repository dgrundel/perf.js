(function(){
	...
	perf.log('Any strings passed to perf.compare() will be added to the log so you can annotate your tests a bit.');
	...
	perf.log('You can have as many setups, tests, and teardowns as you like. Just keep calling setup(), test(), and teardown().', 'note');
	...
	new perf('Error demo')
		.test(function(){
			throw 'If an error is thrown during a test, it will be caught and logged in a line like this.' ;
		})
		.run();

	perf.log('You\'ll also get a message telling you that the test ended prematurely. (see the line above.)');
